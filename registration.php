    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">In this section, you will be able to view all the available classes and you can assign student into their respective classes.</p>
                ...
                <p class="card-text">Please select a student and register them into the available classes above.</p>
                <div class="table-responsive">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo
                                  ...
                                  <td>' . $row['gender'] . '</td>
                                  <td>' . $row['classId'] . '</td>
                                  <td><button class="btn px-0 btn-success btn-block" type="button" onclick="window.location.href=\'registerStudent.php?id=' . $row['id'] . '\'">Register</button></td>                          
                                </tr>';
                            }
