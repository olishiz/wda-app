  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="card">
            <h5 class="card-header">Display Student Records</h5>
            <div class="card-body">
                <p class="card-text">Click the display detail button in order to extract information regarding on student credentials.</p>                
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo
                                  ...
                                  <td>' . $row['studentNo'] . '</td>
                                  <td>' . $row['fullName'] . '</td>															
                                  <td><button class="btn px-0 btn-danger btn-block" style="width: 150px; margin: auto" type="button" onclick="window.location.href=\'displayDetail.php?id=' . $row['id'] . '\'">Display</button></td>                                                    
                                </tr>';
                            }
