...
if (isset($_POST['addClass'])) {
    ...
    if ($idStatus == "true" && $nameStatus == "true" && $classStatus == "true") {
        ...
        $sql = "INSERT INTO class(`classId`, `className`, `yearForm`, `yearGrade`) VALUES ('$classId', '$className', '$yearForm', '$yearGrade')";

        if ($conn->query($sql) === true) {
            $sqlStatus = "success";
            $msg = "Add Class Record Successful!";
        } else {
            $sqlStatus = "failure";
            $msg = "Add Class Record Fail!";
        }
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="card">
            <h5 class="card-header">Add Class Records</h5>
            <div class="card-body">
            <?php 
            ...
            ?>
                <p class="card-text">Adding class records for students.</p>
                <div class="panel-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="">Class ID</label>  
                                <input class="form-control" placeholder="Class ID" name="classId" type="text" style="width: 300px;" required> 
                                <span class="error"><?php echo $classIdErr; ?></span>                           
                                <small class="form-text text-muted">
                                Please enter the class ID. Note: Start each class ID with capital letter 'C' and followed by three digits.
                                </small>                              
                            </div>
                            <div class="form-group">
                                <label for="">Class Name</label>                                
                                <input class="form-control" placeholder="Class Name" name="className" type="text" style="width: 300px;" required>  
                            ...
                            <br>
                            <input class="btn btn-lg btn-primary btn-block" style="width: 300px;" type="submit" value="Add Class" name="addClass">                                                      
                        </form>
